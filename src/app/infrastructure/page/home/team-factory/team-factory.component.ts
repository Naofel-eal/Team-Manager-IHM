...
import { AUTHORIZATION_MANAGER_TOKEN, TEAM_SERVICE_TOKEN as TEAM_SERVICE_TOKEN } from '../../../config/injection-token/injection-token';
...
@Component({
  ...
  standalone: true,
  imports: [UserListComponent, UserFactoryComponent, ButtonModule],
